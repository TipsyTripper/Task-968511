...
public class TriangleAreaTest {
    ...
    @Test
    @DisplayName("If triangle valid")
    public void perimetrTestIfFigure9Valid() {
        init2();
        String answer = String.format("%.2f", triangle.areaOfFigure());
        Assertions.assertEquals("8,25", answer);
    }

    @Test
    @DisplayName("If triangle invalid")
    public void perimetrTestIfFigure5Valid() {
        coords.add(c);
        init2();
        String answer = String.format("%.2f", triangle.areaOfFigure());
